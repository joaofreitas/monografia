...
\addtitle{Caso de Uso 5}{Interação AVA e SMA Frank} 
...
\addscenario{Cenário de Sucesso Principal:}{
	...
	\item O AVA envia os resultados do aluno via web-service para o Sistema SMA, a partir de uma URL disponível no ambiente. Os dados serão enviados, bem como um~\emph{token} de autenticação que identifica o Aluno e o seu grupo de trabalho no sistema.
