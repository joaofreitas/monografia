...
\addtitle{Caso de Uso 3}{Determinar Modelagem Afetiva do Aluno} 
...
\additemizedfield{Interessados e Interesses:}{
	\item Sistema: Criar e manter um modelo afetivo do estudante a partir dos dados gerados da sua interação com um Ambiente Virtual de Aprendizagem (AVA).
...
\addscenario{Cenário de Sucesso Principal:}{
	...
	\item O Sistema utiliza os resultados de atividades feitas pelo aluno para criar um modelo afetivo do estudante, levando em consideração a literatura da psicologia relativa à atividade desenvolvida.
